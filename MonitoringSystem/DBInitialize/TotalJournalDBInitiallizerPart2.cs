...
namespace MonitoringSystem.Models
{
    ...
    {     
        ...
        protected void SubjectInit(ref TotalJournalContext context)
        {
            ...
            context.Subjects.Add(new Subject() {SubjectID = 1, SubjectName = "Основы программирования", SubjectType = SubjectType.Exam, Term = 1 });//
            context.Subjects.Add(new Subject() {SubjectID = 2, SubjectName = "Основы программной инженерии", SubjectType = SubjectType.Exam, Term = 1 });
            context.Subjects.Add(new Subject() {SubjectID = 3, SubjectName = "Компьтерная дискретная математика", SubjectType = SubjectType.Exam, Term = 2 });
            context.Subjects.Add(new Subject() {SubjectID = 4, SubjectName = "Основы программирования", SubjectType = SubjectType.Exam, Term = 2 });
            context.Subjects.Add(new Subject() {SubjectID = 5, SubjectName = "Групповая динамика и коммуникации", SubjectType = SubjectType.Credit, Term = 2 });//
            context.Subjects.Add(new Subject() {SubjectID = 6, SubjectName = "Дискретные структуры", SubjectType = SubjectType.Exam, Term = 3 });
            context.Subjects.Add(new Subject() {SubjectID = 7, SubjectName = "Человеко-машинное взаимодействие", SubjectType = SubjectType.Exam, Term = 3 });
            context.Subjects.Add(new Subject() {SubjectID = 8, SubjectName = "Объектно-ориентированное программирование", SubjectType = SubjectType.Exam, Term = 3 });//
            context.Subjects.Add(new Subject() {SubjectID = 9, SubjectName = "Теория вероятности и математическая статистика", SubjectType = SubjectType.Exam, Term = 3 });
            context.Subjects.Add(new Subject() {SubjectID = 10, SubjectName = "Профессиональная практика программной инженерии", SubjectType = SubjectType.Credit, Term = 3 });
            context.Subjects.Add(new Subject() {SubjectID = 11, SubjectName = "Алгоритмы и структуры данных", SubjectType = SubjectType.Exam, Term = 4 });//
            context.Subjects.Add(new Subject() {SubjectID = 12, SubjectName = "Архитектура ЭОМ", SubjectType = SubjectType.Exam, Term = 4 });
            context.Subjects.Add(new Subject() {SubjectID = 13, SubjectName = "Эмперические методы программной инженерии", SubjectType = SubjectType.Exam, Term = 4 });
            context.Subjects.Add(new Subject() {SubjectID = 14, SubjectName = "Конструирование программного обеспечения", SubjectType = SubjectType.Exam, Term = 4 });
            context.Subjects.Add(new Subject() {SubjectID = 15, SubjectName = "Организация компьтерных сетей", SubjectType = SubjectType.Exam, Term = 4 });
            context.Subjects.Add(new Subject() {SubjectID = 16, SubjectName = "Объектно-ориентированное программирование", SubjectType = SubjectType.Credit, Term = 4 });
            context.Subjects.Add(new Subject() {SubjectID = 17, SubjectName = "Инженерная и компьютерная графика", SubjectType = SubjectType.Exam, Term = 5 });
            context.Subjects.Add(new Subject() {SubjectID = 18, SubjectName = "Анализ требований к программному обеспечению", SubjectType = SubjectType.Exam, Term = 5 });
            context.Subjects.Add(new Subject() {SubjectID = 19, SubjectName = "Операционные системы", SubjectType = SubjectType.Exam, Term = 5 });//
            context.Subjects.Add(new Subject() {SubjectID = 20, SubjectName = "Качество ПО и тестирование", SubjectType = SubjectType.Exam, Term = 5 });
            context.Subjects.Add(new Subject() {SubjectID = 21, SubjectName = "Английский язык", SubjectType = SubjectType.Credit, Term = 5 });
            context.Subjects.Add(new Subject() {SubjectID = 22, SubjectName = "Архитектура и проектирование ПО", SubjectType = SubjectType.Exam, Term = 6 });
            context.Subjects.Add(new Subject() {SubjectID = 23, SubjectName = "Базы данных", SubjectType = SubjectType.Exam, Term = 6 });//
            context.Subjects.Add(new Subject() {SubjectID = 24, SubjectName = "Методы оптимизации и исследования операций", SubjectType = SubjectType.Exam, Term = 6 });
            context.Subjects.Add(new Subject() {SubjectID = 25, SubjectName = "Программирование интернет", SubjectType = SubjectType.Exam, Term = 6 });
            context.Subjects.Add(new Subject() {SubjectID = 26, SubjectName = "Системы искусственного интелекта", SubjectType = SubjectType.Exam, Term = 6 });
            context.Subjects.Add(new Subject() {SubjectID = 27, SubjectName = "Android", SubjectType = SubjectType.Credit, Term = 6 });
            context.Subjects.Add(new Subject() {SubjectID = 28, SubjectName = "Информационные технологии разработки ПО", SubjectType = SubjectType.Exam, Term = 7 });
            context.Subjects.Add(new Subject() {SubjectID = 29, SubjectName = "Безопасность программ и данных", SubjectType = SubjectType.Exam, Term = 7 });//
            context.Subjects.Add(new Subject() {SubjectID = 30, SubjectName = "Проектирование распределенных систем ЭОМ", SubjectType = SubjectType.Exam, Term = 7 });
            context.Subjects.Add(new Subject() {SubjectID = 31, SubjectName = "Проектный практикум", SubjectType = SubjectType.Credit, Term = 7 });
            context.Subjects.Add(new Subject() {SubjectID = 32, SubjectName = "Менеджмент проектов ПО", SubjectType = SubjectType.Exam, Term = 8 });
            context.Subjects.Add(new Subject() {SubjectID = 33, SubjectName = "Проектирование производственных экспертных систем", SubjectType = SubjectType.Exam, Term = 8 });//
            context.Subjects.Add(new Subject() {SubjectID = 34, SubjectName = "Международные стандарты программной инженерии", SubjectType = SubjectType.Exam, Term = 8 });
            context.Subjects.Add(new Subject() {SubjectID = 35, SubjectName = "Проектный практикум", SubjectType = SubjectType.Credit, Term = 8 });
        ...
        /// //такой-то студент посетил(или нет) пару по такому-то предмету в такой-то день
        protected void AttendanceInit(ref TotalJournalContext context)
        {
            ...
            context.Attendances.Add(new Attendance() { AttendanceID = 30, RecordBookNumberID = "436003", SubjectID = 32, ClassDate = DateTime.Now.Date, IsVisited = true });
        ...
        {
            context.SubjectCPs.Add(new SubjectCP() { SubjectCP_ID = 1, SubjectCPName = "Основы программирования(КП)", Term = 3 });
            context.SubjectCPs.Add(new SubjectCP() { SubjectCP_ID = 2, SubjectCPName = "Объектно-ориентированное программирование(КП)", Term = 4 });
            context.SubjectCPs.Add(new SubjectCP() { SubjectCP_ID = 3, SubjectCPName = "Алгоритмы и структуры данных(КП)", Term = 5 });
            context.SubjectCPs.Add(new SubjectCP() { SubjectCP_ID = 4, SubjectCPName = "Операционные системы(КП)", Term = 6 });
            context.SubjectCPs.Add(new SubjectCP() { SubjectCP_ID = 5, SubjectCPName = "Базы данных(КП)", Term = 7 });
            context.SubjectCPs.Add(new SubjectCP() { SubjectCP_ID = 6, SubjectCPName = "Проектирование распределенных систем ЭОП(КП)", Term = 8 });
        }
        ...
        {
            context.HomeWorks.Add(new HomeWork() {HomeWorkID=1 , RecordBookNumberID= "436001", HWNumber= 1, HWPoint = 11, SubjectID= 35, TeacherID= 8, DateOfProgram=DateTime.Now, DateOfReport=DateTime.Now});
            context.HomeWorks.Add(new HomeWork() { HomeWorkID = 2, RecordBookNumberID = "436001", HWNumber = 1, HWPoint = 12, SubjectID = 32, TeacherID = 5, DateOfProgram = DateTime.Now, DateOfReport = DateTime.Now });
            context.HomeWorks.Add(new HomeWork() { HomeWorkID = 3, RecordBookNumberID = "436001", HWNumber = 1, HWPoint = 10, SubjectID = 34, TeacherID = 22, DateOfProgram = DateTime.Now, DateOfReport = DateTime.Now });
            context.HomeWorks.Add(new HomeWork() { HomeWorkID = 4, RecordBookNumberID = "436001", HWNumber = 1, HWPoint = 8, SubjectID = 33, TeacherID = 5, DateOfProgram = DateTime.Now, DateOfReport = DateTime.Now });

            context.HomeWorks.Add(new HomeWork() { HomeWorkID = 5, RecordBookNumberID = "436002", HWNumber = 1, HWPoint = 10, SubjectID = 35, TeacherID = 8, DateOfProgram = DateTime.Now, DateOfReport = DateTime.Now });
            context.HomeWorks.Add(new HomeWork() { HomeWorkID = 6, RecordBookNumberID = "436002", HWNumber = 1, HWPoint = 10, SubjectID = 32, TeacherID = 5, DateOfProgram = DateTime.Now, DateOfReport = DateTime.Now });
            context.HomeWorks.Add(new HomeWork() { HomeWorkID = 7, RecordBookNumberID = "436002", HWNumber = 1, HWPoint = 9, SubjectID = 34, TeacherID = 22, DateOfProgram = DateTime.Now, DateOfReport = DateTime.Now });
            context.HomeWorks.Add(new HomeWork() { HomeWorkID = 8, RecordBookNumberID = "436002", HWNumber = 1, HWPoint = 8, SubjectID = 33, TeacherID = 5, DateOfProgram = DateTime.Now, DateOfReport = DateTime.Now });

            context.HomeWorks.Add(new HomeWork() { HomeWorkID = 9, RecordBookNumberID = "436003", HWNumber = 1, HWPoint = 7, SubjectID = 35, TeacherID = 8, DateOfProgram = DateTime.Now, DateOfReport = DateTime.Now });
            context.HomeWorks.Add(new HomeWork() { HomeWorkID = 10, RecordBookNumberID = "436003", HWNumber = 1, HWPoint = 11, SubjectID = 32, TeacherID = 5, DateOfProgram = DateTime.Now, DateOfReport = DateTime.Now });
            context.HomeWorks.Add(new HomeWork() { HomeWorkID = 11, RecordBookNumberID = "436003", HWNumber = 1, HWPoint = 10, SubjectID = 34, TeacherID = 22, DateOfProgram = DateTime.Now, DateOfReport = DateTime.Now });
            context.HomeWorks.Add(new HomeWork() { HomeWorkID = 12, RecordBookNumberID = "436003", HWNumber = 1, HWPoint = 9, SubjectID = 33, TeacherID = 5, DateOfProgram = DateTime.Now, DateOfReport = DateTime.Now });
        }
    }
}